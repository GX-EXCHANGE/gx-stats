...
@app.get("/gx-exchange/total_users")
...
@app.get("/gx-exchange/total_usd_volume")
...
@app.get("/gx-exchange/total_deposits")
...
@app.get("/gx-exchange/total_withdrawals")
...
@app.get("/gx-exchange/total_notional_liquidated")
...
@app.get("/gx-exchange/cumulative_usd_volume")
...
@app.get("/gx-exchange/daily_usd_volume")
...
@app.get("/gx-exchange/daily_usd_volume_by_coin")
...
@app.get("/gx-exchange/daily_usd_volume_by_crossed")
...
@app.get("/gx-exchange/daily_usd_volume_by_user")
...
@app.get("/gx-exchange/cumulative_trades")
...
@app.get("/gx-exchange/daily_trades")
...
@app.get("/gx-exchange/daily_trades_by_coin")
...
@app.get("/gx-exchange/daily_trades_by_crossed")
...
@app.get("/gx-exchange/daily_trades_by_user")
...
@app.get("/gx-exchange/cumulative_user_pnl")
...
@app.get("/gx-exchange/hlp_liquidator_pnl")
...
@app.get("/gx-exchange/cumulative_hlp_liquidator_pnl")
...
@app.get("/gx-exchange/total_accrued_fees")
...
@app.get("/gx-exchange/asset_ctxs")
...
async def get_asset_ctxs(
    ...
    async with database.transaction():
        ...
        results = await database.fetch_all(query)
        chart_data = [{"time": to_dt(row[0]), "coin": row[1], "avg_oracle_px": row[2], "first_oracle_px": row[3], "avg_open_interest": row[4], "last_oracle_px": row[5]} for row in results]
...
@app.get("/gx-exchange/hlp_positions")
...
@app.get("/gx-exchange/cumulative_liquidated_notional")
...
@app.get("/gx-exchange/daily_notional_liquidated_total")
...
@app.get("/gx-exchange/daily_notional_liquidated_by_leverage_type")
...
@app.get("/gx-exchange/daily_notional_liquidated_by_coin")
...
@app.get("/gx-exchange/daily_unique_users")
...
@app.get("/gx-exchange/daily_unique_users_by_coin")
...
@app.get("/gx-exchange/total_volume")
...
@app.get("/gx-exchange/open_interest")
...
@app.get("/gx-exchange/funding_rate")
...
@app.get("/gx-exchange/cumulative_new_users")
...
@app.get("/gx-exchange/cumulative_inflow")
...
@app.get("/gx-exchange/daily_inflow")
...
@app.get("/gx-exchange/liquidity_by_coin")
    ...
    async with database.transaction():
        query = (
            select(
                ...
                func.percentile_cont(0.5).within_group(
                    market_data_cache.c.median_slippage_30000
                ).label("median_slippage_30000"),
                func.percentile_cont(0.5).within_group(
                    market_data_cache.c.median_slippage_100000
                ).label("median_slippage_100000"),
            ...
            chart_data[coin].append(
                {
                    ...
                    "median_slippage_30000": row["median_slippage_30000"],
                    "median_slippage_100000": row["median_slippage_100000"],
                }
            )
...
@app.get("/gx-exchange/largest_users_by_usd_volume")
...
@app.get("/gx-exchange/largest_user_depositors")
...
@app.get("/gx-exchange/largest_liquidated_notional_by_user")
...
@app.get("/gx-exchange/largest_user_trade_count")
