...
is_online = create_metric("is_gx_exchange_stats_online", "gauge")
api_latency = create_metric("gx_exchange_stats_api_latency", "gauge", labels=["endpoint"])
api_failures = create_metric("gx_exchange_stats_api_failures", "gauge", labels=["endpoint"])
api_successes = create_metric("gx_exchange_stats_api_successes", "gauge", labels=["endpoint"])
